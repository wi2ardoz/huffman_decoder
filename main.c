...
int main()
{
	...
	char * modifiedStr = NULL;			// the output of the function working on saved huffmonT
...
/*
	This function encodes string via Huffman tree depanding on the route.
*/
...
char decodeCharWithHuffmanTree(HuffmanTree * root, char * str)
{
	...
	while (root && str[0]){
		...
		strcpy(str, str + 1);
		if (root && !root->left) return root->ch;
	}
...
/*
	This is Huffman tree initializer function by vals.
*/
...
/*
	This is Huffman tree deallocation function by given root.
*/
...
/*
	This is Huffman list initializer function by vals.
*/
...
/*
	This is Huffman list deallocation function (doesn't deallocate the huffman trees inside).									
*/
...
/*
	This is Huffman list deallocation function.
*/
